...
extension ExtendedNullStringExtension on String? {
  bool get isBlank => this == null || this == '';
  bool get isNotBlank => this != null && this != '';

  DateTime? get dateFromTimeFormat {
    if (isBlank) return null;
    final format = 'hh:mm a';
    final parsedTime = DateFormat(format).tryParse(this!);
